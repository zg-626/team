...
Route::group('api/', function () {
    ...
    Route::group(function () {
        ...
        Route::group('order', function () {
            ...
            Route::post('upload_payment_voucher', '/uploadPaymentVoucher');
...
//        })->prefix('api.server.StoreOrderOffline')->middleware(\app\common\middleware\MerchantServerMiddleware::class, 0);
    ...
    Route::group(function () {
        ...
        Route::group('article', function () {
            ...
            Route::any('backIntegral', 'Article/backIntegral');
        ...
        Route::post('intention/lklChildCate', 'api.store.merchant.MerchantIntention/lklChildCate'); // 商户大类/商户小类
